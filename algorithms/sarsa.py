...
import math
import numpy as np
from config import ACTIONS, EPISODES, MAX_STEPS, ALPHA, GAMMA, VIS_EPISODES
...
def sarsa_reflex_train():
    """
    Train SARSA with reflex shielding.
    ...
    for ep in range(1, EPISODES + 1):
        ...
        for _ in range(MAX_STEPS):
            ...
            Q[(state, a)] = q_sa + ALPHA * (r + GAMMA * q_sna - q_sa)
